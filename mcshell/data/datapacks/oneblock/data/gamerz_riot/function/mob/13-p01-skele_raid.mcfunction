...
# Spawn the mobs
execute as @s at @s run summon minecraft:skeleton_horse ~ ~1.6 ~ {Tame:1b,equipment:{body:{id:"minecraft:diamond_horse_armor",count:1}},Passengers:[{id:"minecraft:skeleton",equipment:{mainhand:{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{"minecraft:power":1}}},feet:{id:"minecraft:golden_boots",count:1,components:{"minecraft:enchantments":{"minecraft:feather_falling":2}}},head:{id:"minecraft:chainmail_helmet",count:1,components:{"minecraft:enchantments":{"minecraft:protection":2,"minecraft:unbreaking":1}}}}}]}
execute as @s at @s run summon minecraft:skeleton_horse ~ ~1.6 ~ {Tame:1b,equipment:{body:{id:"minecraft:diamond_horse_armor",count:1}},Passengers:[{id:"minecraft:skeleton",equipment:{mainhand:{id:"minecraft:bow",count:1,components:{"minecraft:enchantments":{"minecraft:power":1}}},feet:{id:"minecraft:golden_boots",count:1,components:{"minecraft:enchantments":{"minecraft:feather_falling":2}}},head:{id:"minecraft:chainmail_helmet",count:1,components:{"minecraft:enchantments":{"minecraft:protection":2,"minecraft:unbreaking":1}}}}}]}
...
execute as @e[tag=gz-a4-newmob,distance=..30,type=skeleton] at @s if entity @e run data merge entity @s {CustomName:{"text":"Monster Guard","color": "dark_purple"},CustomNameVisible:1b}
