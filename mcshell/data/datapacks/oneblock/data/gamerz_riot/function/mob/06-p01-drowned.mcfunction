...
# Spawn the mobs
execute as @s at @s run summon minecraft:drowned ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:trident",count:1,components:{"minecraft:enchantments":{"minecraft:unbreaking":1}}},feet:{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":1908001}},legs:{id:"minecraft:leather_leggings",count:1},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":3949738,"minecraft:enchantments":{"minecraft:unbreaking":1}}},head:{id:"minecraft:iron_helmet",count:1}}}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:drowned ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:trident",count:1,components:{"minecraft:enchantments":{"minecraft:unbreaking":1}}},feet:{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":1908001}},legs:{id:"minecraft:leather_leggings",count:1},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":3949738,"minecraft:enchantments":{"minecraft:unbreaking":1}}},head:{id:"minecraft:iron_helmet",count:1}}}

# Add new mob tag, and any subsequent NBT changes
execute as @s at @s run tag @e[type=minecraft:drowned,distance=..2,tag=!gz-a4-oldmob] add gz-a4-newmob
