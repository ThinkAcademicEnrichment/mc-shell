export function defineGeneratedWorldActionsGenerators(pythonGenerator) {

    pythonGenerator.forBlock['generatedworldactions_create_explosion'] = function(block, generator) {
...
const power = generator.valueToCode(block, 'power', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.create_explosion(${pos}, ${power})\n`;
...
const amount = generator.valueToCode(block, 'amount', pythonGenerator.ORDER_ATOMIC) || 'None';
    ...
    pythonGenerator.forBlock['generatedworldactions_get_blocks'] = function(block, generator) {
...
const pos2 = generator.valueToCode(block, 'pos2', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.get_blocks(${pos1}, ${pos2})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };

    pythonGenerator.forBlock['generatedworldactions_get_entities_in_radius'] = function(block, generator) {
        const position = generator.valueToCode(block, 'position', pythonGenerator.ORDER_ATOMIC) || 'None';
const radius = generator.valueToCode(block, 'radius', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.get_entities_in_radius(${position}, ${radius})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };
...
const z = generator.valueToCode(block, 'z', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.get_height(${x}, ${z})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };

    pythonGenerator.forBlock['generatedworldactions_remove_entity'] = function(block, generator) {
        const entity_id = generator.valueToCode(block, 'entity_id', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.remove_entity(${entity_id})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };

    pythonGenerator.forBlock['generatedworldactions_set_block'] = function(block, generator) {
        const position = generator.valueToCode(block, 'position', pythonGenerator.ORDER_ATOMIC) || 'None';
const block_type = generator.valueToCode(block, 'block_type', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.set_block(${position}, ${block_type})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };

    pythonGenerator.forBlock['generatedworldactions_set_blocks'] = function(block, generator) {
        const pos1 = generator.valueToCode(block, 'pos1', pythonGenerator.ORDER_ATOMIC) || 'None';
const pos2 = generator.valueToCode(block, 'pos2', pythonGenerator.ORDER_ATOMIC) || 'None';
const block_type = generator.valueToCode(block, 'block_type', pythonGenerator.ORDER_ATOMIC) || 'None';
...
const amount = generator.valueToCode(block, 'amount', pythonGenerator.ORDER_ATOMIC) || 'None';
    ...
    pythonGenerator.forBlock['generatedworldactions_set_sign'] = function(block, generator) {
        const position = generator.valueToCode(block, 'position', pythonGenerator.ORDER_ATOMIC) || 'None';
...
const direction = generator.valueToCode(block, 'direction', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.set_sign(${position}, ${line1}, ${line2}, ${line3}, ${line4}, ${sign_type}, ${direction})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };

    pythonGenerator.forBlock['generatedworldactions_spawn_entity'] = function(block, generator) {
        const position = generator.valueToCode(block, 'position', pythonGenerator.ORDER_ATOMIC) || 'None';
const entity_id = generator.valueToCode(block, 'entity_id', pythonGenerator.ORDER_ATOMIC) || 'None';
        const code = `GeneratedWorldActions.spawn_entity(${position}, ${entity_id})\n`;
        return block.outputConnection ? [code.trim(), pythonGenerator.ORDER_ATOMIC] : code;
    };
}