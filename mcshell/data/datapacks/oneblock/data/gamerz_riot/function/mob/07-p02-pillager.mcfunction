...
# Spawn the mobs
execute as @s at @s run summon minecraft:pillager ~ ~1.6 ~ {equipment:{mainhand:{count:1,id:"minecraft:crossbow",components:{"minecraft:enchantments":{"minecraft:quick_charge":1}}}}}
