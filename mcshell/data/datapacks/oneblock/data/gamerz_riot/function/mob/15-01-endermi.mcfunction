...
execute as @s at @s run summon minecraft:endermite ~ ~1.6 ~
execute as @s at @s run summon minecraft:endermite ~ ~1.6 ~
execute as @s[scores={gz-a4-mobamount=3..}] at @s run summon minecraft:endermite ~ ~1.6 ~
execute as @s[scores={gz-a4-mobamount=4..}] at @s run summon minecraft:endermite ~ ~1.6 ~

# Add new mob tag, and any subsequent NBT changes
execute as @s at @s run tag @e[type=minecraft:endermite,distance=..2,tag=!gz-a4-oldmob] add gz-a4-newmob
