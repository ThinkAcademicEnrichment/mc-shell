...
class EventsNamespace:
    ...
    def pollRightBlockHits(self): return self.poll('rightBlockHit')

    def pollLeftBlockHits(self): return self.poll('leftBlockHit')

    def pollBlockPlaces(self): return self.poll('blockPlace')

    def pollBlockBreaks(self): return self.poll('blockBreak')

    def pollChats(self): return self.poll('chat')

    def pollProjectileHitBlocks(self): return self.poll('projectileHitBlock')

    def pollProjectileHitEntitys(self): return self.poll('projectileHitEntity')

    def pollProjectileLaunchs(self): return self.poll('projectileLaunch')

    def pollPlayerDeaths(self): return self.poll('playerDeath')

    def pollPlayerRespawns(self): return self.poll('playerRespawn')