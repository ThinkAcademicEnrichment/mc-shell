...
# Spawn the mobs
execute as @s at @s run summon minecraft:husk ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:iron_spear",count:1}}}
execute as @s at @s run summon minecraft:husk ~ ~1.6 ~
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:husk ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:iron_spear",count:1}}}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:husk ~ ~1.6 ~
