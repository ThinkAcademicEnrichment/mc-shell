...
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:horse ~ ~1.6 ~

# Add new mob tag, and any subsequent NBT changes
execute as @s at @s run tag @e[type=minecraft:horse,distance=..2,tag=!gz-a4-oldmob] add gz-a4-newmob
