...
# Spawn the mobs
execute as @s at @s run summon minecraft:elder_guardian ~ ~1.6 ~

# Add new mob tag, and any subsequent NBT changes
execute as @s at @s run tag @e[type=minecraft:elder_guardian,distance=..2,tag=!gz-a4-oldmob] add gz-a4-newmob
