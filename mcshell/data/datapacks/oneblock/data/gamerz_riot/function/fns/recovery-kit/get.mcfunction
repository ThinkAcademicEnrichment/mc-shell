...
execute if entity @e[tag=gz-a4-block,scores={gz-a4-riot=8624..9723}] run function gamerz_riot:fns/recovery-kit/12
execute if entity @e[tag=gz-a4-block,scores={gz-a4-riot=9724..10553}] run function gamerz_riot:fns/recovery-kit/13
execute if entity @e[tag=gz-a4-block,scores={gz-a4-riot=10554..11319}] run function gamerz_riot:fns/recovery-kit/14
execute if entity @e[tag=gz-a4-block,scores={gz-a4-riot=11320..12336}] run function gamerz_riot:fns/recovery-kit/15

execute if entity @e[tag=gz-a4-block,scores={gz-a4-riot=12337..}] run function gamerz_riot:fns/recovery-kit/16
