...
# Spawn the mobs
execute as @s at @s run execute as @s at @s run summon minecraft:stray ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:bow",count:1},head:{id:"minecraft:copper_helmet",count:1}}}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:stray ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:bow",count:1},head:{id:"minecraft:copper_helmet",count:1}}}
