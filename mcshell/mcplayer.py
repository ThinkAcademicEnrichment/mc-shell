...
class MCPlayer(MCClient):
    def __init__(self, name, host=MC_SERVER_HOST, port=MC_SERVER_PORT, rcon_port=MC_RCON_PORT, mj_port=MJ_PLUGIN_PORT, app_port=MC_APP_PORT, password=None, cancel_event=None):
        super().__init__(host, port, rcon_port, mj_port,app_port,password)
        self.name = name
