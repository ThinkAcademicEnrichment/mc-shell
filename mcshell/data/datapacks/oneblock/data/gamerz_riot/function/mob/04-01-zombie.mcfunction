...
# Spawn the mobs
execute as @s at @s run summon minecraft:zombie ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:iron_shovel",count:1},head:{id:"minecraft:copper_helmet",count:1}}}
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:zombie ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:iron_hoe",count:1},head:{id:"minecraft:copper_helmet",count:1}}}
