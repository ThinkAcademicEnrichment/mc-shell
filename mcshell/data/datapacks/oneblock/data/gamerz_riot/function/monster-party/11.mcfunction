scoreboard players set @s[scores={gz-a4-partytime=0}] gz-a4-partytime 285
...
execute as @s[scores={gz-a4-partytime=200}] at @s run function gamerz_riot:mob/11-p02-witch
execute as @s[scores={gz-a4-partytime=175}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=175}] at @s run function gamerz_riot:mob/11-p01-bee
execute as @s[scores={gz-a4-partytime=150}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=150}] at @s run function gamerz_riot:mob/11-p01-bee
execute as @s[scores={gz-a4-partytime=125}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=125}] at @s run function gamerz_riot:mob/11-p02-witch