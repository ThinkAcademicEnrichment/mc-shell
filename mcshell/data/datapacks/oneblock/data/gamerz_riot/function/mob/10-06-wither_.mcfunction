...
# Spawn the mobs
execute as @s at @s run summon minecraft:wither_skeleton ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:stone_sword",count:1}}}
execute as @s[scores={gz-a4-mobamount=3..}] at @s run summon minecraft:wither_skeleton ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:stone_sword",count:1}}}
