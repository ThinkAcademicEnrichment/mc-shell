...
# Spawn the mobs
execute as @s at @s run summon minecraft:zombie ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:copper_shovel",count:1,components:{"minecraft:enchantments":{"minecraft:unbreaking":1}}},feet:{id:"minecraft:leather_boots",count:1,components:{"minecraft:dyed_color":1908001}},legs:{id:"minecraft:leather_leggings",count:1,components:{"minecraft:dyed_color":3949738}},chest:{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:dyed_color":3847130,"minecraft:enchantments":{"minecraft:unbreaking":1}}},head:{id:"minecraft:copper_helmet",count:1}}}
