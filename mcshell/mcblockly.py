...
COLORABLE_BASE_RULES = {
    ...
    'SHULKER_BOX': re.compile(r"^(WHITE|ORANGE|MAGENTA|LIGHT_BLUE|YELLOW|LIME|PINK|GRAY|LIGHT_GRAY|CYAN|PURPLE|BLUE|BROWN|GREEN|RED|BLACK)_SHULKER_BOX$"),
    'BANNER': re.compile(r"^(WHITE|ORANGE|MAGENTA|LIGHT_BLUE|YELLOW|LIME|PINK|GRAY|LIGHT_GRAY|CYAN|PURPLE|BLUE|BROWN|GREEN|RED|BLACK)_BANNER$"),
    'WALL_BANNER': re.compile(r"^(WHITE|ORANGE|MAGENTA|LIGHT_BLUE|YELLOW|LIME|PINK|GRAY|LIGHT_GRAY|CYAN|PURPLE|BLUE|BROWN|GREEN|RED|BLACK)_WALL_BANNER$"),
    'GLAZED_TERRACOTTA': re.compile(r"^(WHITE|ORANGE|MAGENTA|LIGHT_BLUE|YELLOW|LIME|PINK|GRAY|LIGHT_GRAY|CYAN|PURPLE|BLUE|BROWN|GREEN|RED|BLACK)_GLAZED_TERRACOTTA$"),
...
MATERIAL_PICKER_GROUPS = {
    ...
    "lighting": [
        ...
        "OCHRE_FROGLIGHT", "PEARLESCENT_FROGLIGHT", "VERDANT_FROGLIGHT", "COPPER_LANTERN",
        "EXPOSED_COPPER_LANTERN", "WEATHERED_COPPER_LANTERN", "OXIDIZED_COPPER_LANTERN",
        "SHROOMLIGHT", "JACK_O_LANTERN", "BEACON", "END_ROD"
    ],
    ...
    "vegetation_nature": [
        ...
        "FLOWERING_AZALEA_LEAVES", "SHORT_GRASS", "TALL_GRASS", "FERN", "LARGE_FERN",
        "VINE", "CAVE_VINES", "TWISTING_VINES", "WEEPING_VINES", "MOSS_BLOCK", "PALE_MOSS_BLOCK"
    ],
    ...
    "functional_storage": [
        ...
        "DECORATED_POT", "CRAFTER", "FURNACE", "BLAST_FURNACE", "SMOKER"
    ],

    "stone_types": [
        "ANDESITE", "POLISHED_ANDESITE", "DIORITE", "POLISHED_DIORITE",
        "GRANITE", "POLISHED_GRANITE", "BASALT", "POLISHED_BASALT", "SMOOTH_BASALT",
        "TUFF", "POLISHED_TUFF", "CHISELED_TUFF", "TUFF_BRICKS", "POLISHED_TUFF_WALL"
    ],
