...
pythonGenerator.forBlock['pyncraft_actions_set_position_by_name'] = function(block, generator) {
    const player_name = generator.valueToCode(block, 'PLAYER_NAME', generator.ORDER_ATOMIC) || '';
    const position = generator.valueToCode(block, 'POSITION', generator.ORDER_ATOMIC) || 'None';
    return `self.action_implementer.set_position_by_name(player_name=${player_name}, position=${position})\n`;
};
pythonGenerator.forBlock['pyncraft_actions_set_rotation_by_name'] = function(block, generator) {
    ...
    return `self.action_implementer.set_rotation_by_name(player_name=${player_name}, yaw=${yaw}, pitch=${pitch})\n`;
};
