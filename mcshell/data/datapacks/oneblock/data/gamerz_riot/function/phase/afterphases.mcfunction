...
execute as @s[scores={gz-a4-randafter=1..395}] at @s run function gamerz_riot:random-block/15
...
execute as @s[scores={gz-a4-randafter=396..397}] at @s run setblock ~ ~ ~ minecraft:chest[facing=east]{"LootTable":"gamerz_riot:15-variety"}
