...
export function defineDigitalGeometryGenerators(pythonGenerator) {
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_ball'] = function(block, generator) {
        ...
        const radius = generator.valueToCode(block, 'RADIUS', generator.ORDER_ATOMIC) || null;
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_cube'] = function(block, generator) {
        ...
        const rotation_matrix = generator.valueToCode(block, 'ROTATION_MATRIX', generator.ORDER_ATOMIC) || Matrix3.identity();
        const block_type = generator.valueToCode(block, 'BLOCK_TYPE', generator.ORDER_ATOMIC) || null;
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_disc'] = function(block, generator) {
        const center = generator.valueToCode(block, 'CENTER', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const normal = generator.valueToCode(block, 'NORMAL', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const radius = generator.valueToCode(block, 'RADIUS', generator.ORDER_ATOMIC) || null;
        const block_type = generator.valueToCode(block, 'BLOCK_TYPE', generator.ORDER_ATOMIC) || null;
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_line'] = function(block, generator) {
        ...
        const point2 = generator.valueToCode(block, 'POINT2', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const block_type = generator.valueToCode(block, 'BLOCK_TYPE', generator.ORDER_ATOMIC) || null;
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_sphere'] = function(block, generator) {
        const center = generator.valueToCode(block, 'CENTER', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const radius = generator.valueToCode(block, 'RADIUS', generator.ORDER_ATOMIC) || null;
        const block_type = generator.valueToCode(block, 'BLOCK_TYPE', generator.ORDER_ATOMIC) || null;
        const is_hollow = generator.valueToCode(block, 'IS_HOLLOW', generator.ORDER_ATOMIC) || null;
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_tetrahedron'] = function(block, generator) {
        const p1 = generator.valueToCode(block, 'P1', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const p2 = generator.valueToCode(block, 'P2', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const p3 = generator.valueToCode(block, 'P3', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const p4 = generator.valueToCode(block, 'P4', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const inner_offset_factor = generator.valueToCode(block, 'INNER_OFFSET_FACTOR', generator.ORDER_ATOMIC) || null;
        const block_type = generator.valueToCode(block, 'BLOCK_TYPE', generator.ORDER_ATOMIC) || null;
    ...
    pythonGenerator.forBlock['minecraft_action_create_digital_tube'] = function(block, generator) {
        const start = generator.valueToCode(block, 'START', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const end = generator.valueToCode(block, 'END', generator.ORDER_ATOMIC) || Vec3(0,0,0);
        const radius = generator.valueToCode(block, 'RADIUS', generator.ORDER_ATOMIC) || null;
        const block_type = generator.valueToCode(block, 'BLOCK_TYPE', generator.ORDER_ATOMIC) || null;
        const is_hollow = generator.valueToCode(block, 'IS_HOLLOW', generator.ORDER_ATOMIC) || null;
