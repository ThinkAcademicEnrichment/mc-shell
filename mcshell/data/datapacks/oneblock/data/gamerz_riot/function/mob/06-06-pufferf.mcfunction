...
# Spawn the mobs
execute as @s at @s run summon minecraft:pufferfish ~ ~1.6 ~
execute as @s[scores={gz-a4-mobamount=2..}] at @s run summon minecraft:pufferfish ~ ~1.6 ~

# Add new mob tag, and any subsequent NBT changes
execute as @s at @s run tag @e[type=minecraft:pufferfish,distance=..2,tag=!gz-a4-oldmob] add gz-a4-newmob
