...
export function defineGeneratedWorldActionsBlocks(Blockly) {

    Blockly.Blocks['generatedworldactions_create_explosion'] = {
        init: function() {
...
this.appendValueInput('amount').appendField('Amount').setCheck('Number');
    ...
    Blockly.Blocks['generatedworldactions_get_blocks'] = {
        init: function() {
...
this.appendValueInput('pos2').appendField('To Position').setCheck('3DVector');
    ...
    Blockly.Blocks['generatedworldactions_get_entities_in_radius'] = {
        init: function() {
...
this.appendValueInput('z').appendField('Z').setCheck('Number');
    ...
    Blockly.Blocks['generatedworldactions_remove_entity'] = {
        init: function() {
    ...
    Blockly.Blocks['generatedworldactions_set_block'] = {
        init: function() {
...
this.appendValueInput('block_type').appendField('Block').setCheck('Block');
    ...
    Blockly.Blocks['generatedworldactions_set_blocks'] = {
        init: function() {
...
this.appendValueInput('amount').appendField('Amount').setCheck('Number');
    ...
    Blockly.Blocks['generatedworldactions_set_sign'] = {
        init: function() {
...
this.appendValueInput('direction').appendField('Direction (0-15)').setCheck('Number');
    ...
    Blockly.Blocks['generatedworldactions_spawn_entity'] = {
        init: function() {
