...
# Spawn the mobs
execute as @s at @s run summon minecraft:piglin ~ ~1.6 ~ {equipment:{mainhand:{id:"minecraft:golden_sword",count:1,components:{"minecraft:enchantments":{"minecraft:unbreaking":1}}},feet:{id:"minecraft:golden_boots",count:1},legs:{id:"minecraft:golden_leggings",count:1},chest:{id:"minecraft:golden_chestplate",count:1,components:{"minecraft:enchantments":{"minecraft:unbreaking":1}}},head:{id:"minecraft:golden_helmet",count:1}}}
